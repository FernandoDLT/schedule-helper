...
function loadAppointments() {
    ...
    // Clear current events and render updated events
    $('#calendar').fullCalendar('removeEvents');
    $('#calendar').fullCalendar('renderEvents', events, true);
}

// Initialize the calendar and load appointments
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (calendarElement.length) {
        ...
        loadAppointments(); // Load events on calendar init
    }
});

// Form submission to add or update appointment
...
function addNewAppointment(appointment) {
    ...
    loadAppointments(); // Reload calendar events
    alert('Appointment successfully booked!');
}

// Modify existing appointment
function modifyAppointment(updatedAppointment) {
    let appointments = JSON.parse(localStorage.getItem('appointments')) || [];
