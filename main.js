...
//             // Normalize date and time for conflict checking
//             const normalizedDate = new Date(dateInput).toISOString().split('T')[0];
//             const normalizedTime = timeInput.padStart(5, '0'); // Ensure time format is HH:mm
